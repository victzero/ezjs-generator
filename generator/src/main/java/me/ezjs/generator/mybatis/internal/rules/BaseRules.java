 ...
 */
package me.ezjs.generator.mybatis.internal.rules;
...
public abstract class BaseRules implements Rules {
    ...
    /* (non-Javadoc)
     * @see Rules#generateCountByExample()
     */
    ...
    /* (non-Javadoc)
     * @see Rules#generateUpdateByExampleSelective()
     */
    ...
    /* (non-Javadoc)
     * @see Rules#generateUpdateByExampleWithoutBLOBs()
     */
    ...
    /* (non-Javadoc)
     * @see Rules#generateUpdateByExampleWithBLOBs()
     */
    ...
    /* (non-Javadoc)
     * @see Rules#getIntrospectedTable()
     */
    ...
    /* (non-Javadoc)
     * @see Rules#generateBaseColumnList()
     */
    ...
    /* (non-Javadoc)
     * @see Rules#generateBlobColumnList()
     */
