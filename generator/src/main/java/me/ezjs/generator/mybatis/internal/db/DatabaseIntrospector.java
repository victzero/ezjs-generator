...
import me.ezjs.generator.mybatis.api.dom.java.JavaReservedWords;
...
import me.ezjs.generator.mybatis.logging.Log;
import me.ezjs.generator.mybatis.logging.LogFactory;
...
public class DatabaseIntrospector {
    ...
    private void enhanceIntrospectedTable(IntrospectedTable introspectedTable) {
        try {
            ...
            warnings.add(Messages.getString("Warning.27", e.getMessage())); //$NON-NLS-1$
        }
    }
}
