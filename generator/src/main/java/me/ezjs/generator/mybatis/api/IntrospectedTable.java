...
import me.ezjs.generator.mybatis.config.SqlMapGeneratorConfiguration;
import me.ezjs.generator.mybatis.internal.rules.ConditionalModelRules;
import me.ezjs.generator.mybatis.config.GeneratedKey;
import me.ezjs.generator.mybatis.config.JavaClientGeneratorConfiguration;
import me.ezjs.generator.mybatis.config.JavaModelGeneratorConfiguration;
import me.ezjs.generator.mybatis.config.ModelType;
import me.ezjs.generator.mybatis.config.PropertyHolder;
import me.ezjs.generator.mybatis.config.PropertyRegistry;
import me.ezjs.generator.mybatis.config.TableConfiguration;
import me.ezjs.generator.mybatis.internal.rules.FlatModelRules;
import me.ezjs.generator.mybatis.internal.rules.HierarchicalModelRules;
...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_EZJS_BASE_PACKAGE_TYPE, /** The ATT r_ mybati s3_ sq l_ provide r_ type. */
    ...
    public String getEzjsMapperType() {
        return internalAttributes.get(InternalAttribute.ATTR_EZJS_MAPPER_TYPE);
    }

    public String getBasePackageType() {
        return internalAttributes.get(InternalAttribute.ATTR_EZJS_BASE_PACKAGE_TYPE);
    }
    ...
    protected String calculateBasePackage() {
        JavaModelGeneratorConfiguration config = context
                .getJavaModelGeneratorConfiguration();
    ...
    protected void calculateModelAttributes() {
        String basePackage = calculateBasePackage();
        String pakkage = basePackage + ".model";
        ...
        String mapperPakkage = basePackage + ".mapper";
        sb.setLength(0);
        sb.append(mapperPakkage);
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("Mapper"); //$NON-NLS-1$
        setEzjsMapperType(sb.toString());

        setEzjsBasePackageType(basePackage);
    }
    ...
    public void setEzjsMapperType(String mapperType) {
        internalAttributes
                .put(InternalAttribute.ATTR_EZJS_MAPPER_TYPE, mapperType);
    }

    public void setEzjsBasePackageType(String basePackageType) {
        internalAttributes
                .put(InternalAttribute.ATTR_EZJS_BASE_PACKAGE_TYPE, basePackageType);
    }
